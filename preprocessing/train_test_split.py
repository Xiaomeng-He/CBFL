...
def get_train_val_case_list(df, 
    ...
    timestamp: datetime
        Name of column containing timestamp
    event_log: str
        Name of the event log. Specify as 'bpic2019' when using the BPIC2019 
        event log.
    ...
    if event_log == 'bpic2019':
        full_training_case_list = df[case_id].unique().tolist()
        train_case_list, val_case_list = train_test_split(full_training_case_list, test_size=val_ratio)
